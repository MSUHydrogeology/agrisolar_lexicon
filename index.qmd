...
**[settlements](chapters/5-settlements.qmd)** — ways the pressures have been resolved
at particular scales and sharing postures.

In one line: three structural devices (scale, sharing–sparing, pressures) →
**[general terminology](chapters/4-general-terminology.qmd)** →
**[settlements](chapters/5-settlements.qmd)** →
**[open issues](chapters/6-open-issues.qmd)**.
...
- The **[open issues](chapters/6-open-issues.qmd)** list records decisions the document
