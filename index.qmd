...
::: {.welcome}
Solar and farming want the same ground: flat, open, well drained, and generous with sun. Both
are ways of harvesting sunlight over a wide area, so the competition between them is inherent
rather than incidental — every acre of panels is an acre of crop, and that is the argument now
running in county boardrooms across the country. But an array is not one thing. The same acres
can carry pollinator habitat or bare gravel, slow a field's runoff or speed it, build soil
carbon or strip it, shade a herd through a July afternoon, take irrigation off an aquifer being
drawn down, or carry a farm through a decade that would otherwise have ended it. None of that
is a side effect. Those are design decisions, made differently on every site, and made well
they settle the tension rather than resolve it in one direction.

**Agrisolar** is the name for that whole field: solar generation on agricultural land, whatever
happens to production underneath. It is worth distinguishing from **agrivoltaics**, the
better-known term, which covers the narrower case of crops or livestock raised inside the array
itself — sheep between the rows, lettuce in the shade of a panel. That case is real, and it is
rare: cropping directly under or between panels runs on the order of 2% of what has been built
[@stid2022; @macknick2022]. The rest is still solar on farmland, and it still decides where the
water goes, what lives in the soil, and whether the farm is still farming in ten years.

**Restorative agrisolar design** is a claim about the wider category — that these arrays can be
built so the land and the community around them are better off for their presence, and that
ecological, hydrological, and community function belong among the objectives of the design
rather than among its accidents. This document argues that claim rather than assuming it, and
gives it a vocabulary precise enough to be tested on real ground.
:::
