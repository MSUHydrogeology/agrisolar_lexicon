...
- **New Urbanism.** *The Lexicon of New Urbanism* (DPZ); SmartCode v9.2 and v10; Center for Applied Transect Studies; Form-Based Codes Institute; CNU. Form-based code rigidity critiques (Miami 21, Poundbury) are drawn from commentary rather than primary evaluation literature and should be strengthened.
...
- **Overstory Agrivoltaic — Domaine de Nidolères**, Tresserre, France. Sun'Agri project page (sunagri.fr/en/project/nidoleres-estate) and *L'Écho du Solaire*; the "world's first agrivoltaic vineyard power plant" phrasing is the developer's. Peer-reviewed corroboration of dynamic-agrivoltaic tree-crop effects: Juillion, P. et al. (2022), Shading apple trees with an agrivoltaic system, *Scientia Horticulturae* 306 (HAL hal-04185057).
- **Grazed Habitat Array — Aurora Solar**, Minnesota (150 MW-dc, 16 sites, operational 2017). Enel Green Power project page; Fresh Energy case study; NREL InSPIRE pollinator research.
- **Buffer-Integrated Array — Ramsey Renewable Station** (Connexus Energy), Ramsey, MN. Fresh Energy case study and the DOE **PV-SMaRT** project (University of Minnesota stormwater modelling); the no-detention-basin result is from PV-SMaRT modelling of the site.
- **Marginal-Land Diversification — Cozy Cove Farm**, Gurley, AL (50 kW / 208 panels, elevated ~7 ft, TVA offtake). NCAT AgriSolar Clearinghouse case study.
