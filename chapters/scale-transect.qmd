...
: The five zones, and the attributes that move together along them. Capacity is how a project is filed and acreage is how a place experiences it, so the acres are the better guide where the two disagree. {#tbl-zones}
:::
