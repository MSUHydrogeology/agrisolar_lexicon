...
- **[Siting-led](terminology.qmd#term-siting-led)** — put the array where the ground itself does the work. [Solar prairie strips](archetypal_forms.qmd#arch-prairie-strips) are the case: the planting goes where the runoff already goes.
- **[Structure-led](terminology.qmd#term-structure-led)** — build the geometry to do it: clearance, row spacing, how much light the modules let through. [Barnyard shelter](archetypal_forms.qmd#arch-barnyard) is the case.
...
- **[Ownership-led](terminology.qmd#term-ownership-led)** — structure the holding so that no agreement is required, because the interests were never opposed. [Barnyard shelter](archetypal_forms.qmd#arch-barnyard) is the case again, and for a second reason: the person who owns the array owns the animals standing under it.
