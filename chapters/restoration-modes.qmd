...
- **[Structure-led](terminology.qmd#term-structure-led)** — build the geometry to do it: clearance, row spacing, how much light the modules let through. [Barnyard shelter](archetypal-forms.qmd#arch-barnyard) is the case.
