...
A3 sits near that crossing, which is why it behaves differently from either end of the transect. A parcel of forty or eighty acres is big enough that management matters: someone is hired to seed it, a grazier arrives with a flock, and maintenance has a line of its own in the budget. It is also still small enough to site strategically, because a developer and a landowner can walk the ground together and decide which part of it the array takes. At A1 there is little to choose between, and by A5 the choice has usually been made already by whatever land could be assembled near a substation.
