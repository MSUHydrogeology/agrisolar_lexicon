...
**The top of the transect keeps going.** A5 is open-ended by design: it holds everything from a 50 MW single site to multi-thousand-acre regional complexes and the emerging 5,000–10,000+ acre, gigawatt-class developments. These differ enormously in land assembly, jurisdiction count, and community interface, and a future calibration may well split A5 — but the restoration problem stays recognisably the same across them (management-led, contract-enterprise), which is why the lexicon has not split it yet (§8, issue 1).
