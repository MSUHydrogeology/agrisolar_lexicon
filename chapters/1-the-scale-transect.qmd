...
:::: {#sec-grazing .example}
**A worked example: grazing across the transect.** A transect is only worth having if naming a zone tells you something you did not already know. Here is the test. Take one practice, sheep grazing, and follow it from the farmstead to the region. The name never changes. The job changes three times.
...
Terms introduced in this section are defined in the [Terminology](7-terminology.qmd) chapter (§7), under [Scale](7-terminology.qmd#sec-terms-scale), alongside every other term the document defines.
