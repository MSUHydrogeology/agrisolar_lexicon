...
### 1.3 A worked example: grazing across the transect {#sec-grazing}

A transect is only worth having if naming a zone tells you something you did not already know. Here is the test. Take one practice, sheep grazing, and follow it from the farmstead to the region. The name never changes. The job changes three times.
