...
| **Latitude** | Sets sun angle, tilt, row spacing, and therefore [ground coverage](terminology.qmd#term-gcr). Wider northern rows give the ground layer more light and use more land; tighter southern arrays do the reverse. The resulting [pore space](terminology.qmd#term-pore-space) is why [vertical bifacial](terminology.qmd#term-module-technology) primary agriculture (S1) is not equally viable nationwide |
...
| **Irrigation** | Makes [impaired-land siting](terminology.qmd#term-s5) possible where a district exceeds its aquifer budget, because retiring demand saves water and solar makes the retirement pay. Rain-fed regions have no consumptive use to retire, and their water work is interception instead |
