...
![Nine pressures bearing on one site at once, arranged by the direction each pushes. The two coloured groups never meet, because the three whose direction is decided by the site, the buyer, or the county sit in the grey wedges between them.](../figures/fig_design_pressures.svg){#fig-design-pressures}

## The pressures {#sec-pressures}

Three of the nine push toward restoration, three push away, and the direction of the remaining three is settled by the site, the buyer, or the county. Restorative goals is the one this lexicon exists to advance, and it is still a force among forces rather than a score to hold a project against. Nine forces act on every site. The third column is the one worth arguing about, because it is where a project's [restorative](terminology.qmd#term-restorative) claim is won or lost. Three push toward restoration, three push away, and three go both ways depending on the site, the buyer, or the county. Two pressures can point the same way and still collide, which is what makes the [reversibility](terminology.qmd#term-decommissioning) argument in §-@sec-conflicts the hard one.
