...
![**How an archetype emerges.** Design tension against the [design pressures](design-pressures.qmd): a position along the bottom is one way the nine can come out, and the height is how much conflict that resolution leaves standing. Where the pressures accommodate each other the curve drops, and projects settle into the low spots the way water finds a hollow. A low spot that keeps collecting projects is what this chapter calls an archetype, named on the curve with the scale and siting code it carries. Nothing here is a design process: no project chose its basin, and the basins are the shape the pressures leave behind once they have finished arguing. The landscape is also not the same everywhere, because [a region weights the pressures differently](design-pressures.qmd#sec-regionality). The dashed profile is an arid region, where retiring irrigated ground is much the deepest basin on the curve and the prairie-strip basin has nearly flattened away. **A basin that flattens is a form that stops being built.**](../figures/fig_archetypes_emerge.svg){#fig-archetypes-emerge}
...
|---|---|
| **S1 — Primary agriculture** | [**Vegetable Agrivoltaics**](#arch-vegetable) · [Solar Fencerows](#arch-vertical-bifacial) · [Vineyard and Orchard Canopy](#arch-permanent-crop) · [**Barnyard Shelter Solar**](#arch-barnyard) · [**Regenerative Solar Grazing**](#arch-grazing) on ground that was already pasture |
| **S2 — Secondary agriculture** | [**Regenerative Solar Grazing**](#arch-grazing) on former cropland · [**Marginal Land Solar**](#arch-marginal) where stock stays on · [Pollinator Meadow Solar](#arch-community-solar) where hives are kept |
...
[A1](scale-transect.qmd#sec-zones) scale · **[S1](siting-axis.qmd#sec-positions)** siting · *[ownership-led](restoration-modes.qmd#sec-siting-latitude)* restoration
...
[A4–A5](scale-transect.qmd#sec-zones) scale · **[S1–S2](siting-axis.qmd#sec-positions)** siting · *[management-led](restoration-modes.qmd#sec-siting-latitude)* restoration
