---
title: "1. The Scale Transect"
nav_order: 3
---

# 1. The Scale Transect

### 1.1 Why scale, and why a transect rather than bins
...
![The agroenergy scale transect, zones A1 to A5]({{ '/figures/fig1_scale_transect.svg' | relative_url }})

***Figure 1.** The Scale Transect. Interconnection posture, siting latitude, and restoration mode covary along a single gradient — which is what makes it a transect rather than a set of size bins.*
...
### 1.3 Why the transect earns its place
...
### 1.4 Siting latitude and the restoration mode shift
...
![Siting latitude and management leverage across the transect]({{ '/figures/fig2_siting_latitude.svg' | relative_url }})

***Figure 2.** Siting latitude and management leverage move in opposite directions and cross between A3 and A4. Restoration does not diminish with scale so much as change instrument.*
